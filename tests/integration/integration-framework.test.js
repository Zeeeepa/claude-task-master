...
describe('Integration Framework', () => {
    ...
    describe('Initialization', () => {
        ...
        test('should throw error when initializing twice', async () => {
            await framework.initialize();
            await expect(framework.initialize()).rejects.toThrow('already initialized');
        });
    ...
    describe('Component Registration', () => {
        ...
        test('should register component successfully', async () => {
            ...
            const result = await framework.registerComponent(componentConfig, mockComponent);
    ...
    describe('Component Discovery', () => {
        ...
        test('should discover components by type', async () => {
            ...
            expect(Array.isArray(components) ? components : [components]).toHaveLength(1);
        });
...
describe('Integration Framework - End-to-End', () => {
    ...
    test('should handle complete workflow', async () => {
        ...
        const dbResult = await framework.sendRequest('database', 'query', 'SELECT * FROM test');
        ...
        const processResult = await framework.sendRequest('processor', 'process', { input: 'test' });
