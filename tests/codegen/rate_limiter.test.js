...
import { RateLimiter, QuotaManager } from '../../src/ai_cicd_system/core/rate_limiter.js';
...
describe('RateLimiter', () => {
    ...
    describe('acquire', () => {
        ...
        it('should respect priority in queue', async () => {
            ...
            rateLimiter.acquire({ priority: 'normal' }).then(() => results.push('normal'));
            rateLimiter.acquire({ priority: 'high' }).then(() => results.push('high'));
        ...
        it('should reject when queue is full', async () => {
            ...
            await expect(rateLimiter.acquire()).rejects.toThrow('Rate limit exceeded and queue is full');
        });
    });
