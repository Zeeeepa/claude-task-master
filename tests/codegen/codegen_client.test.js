...
describe('CodegenAgent', () => {
    ...
    describe('constructor', () => {
        ...
        it('should throw error without required config', () => {
            expect(() => new CodegenAgent({})).toThrow('Codegen Agent requires org_id and token');
        });
...
describe('CodegenError', () => {
    describe('constructor', () => {
        ...
        it('should preserve original error', () => {
            ...
            const error = new CodegenError('TEST_ERROR', 'Test message', originalError);
    ...
    describe('isRetryable', () => {
        it('should identify retryable errors', () => {
            const retryableError = new CodegenError('NETWORK_ERROR', 'Network failed');
            expect(retryableError.isRetryable()).toBe(true);
        });

        it('should identify non-retryable errors', () => {
            const nonRetryableError = new CodegenError('AUTHENTICATION_FAILED', 'Auth failed');
    ...
    describe('getUserMessage', () => {
        it('should return user-friendly message for known codes', () => {
            ...
            expect(error.getUserMessage()).toBe('Invalid API credentials. Please check your token and org_id.');
        });
