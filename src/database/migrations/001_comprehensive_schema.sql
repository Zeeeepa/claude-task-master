...
-- Description: Create comprehensive database schema for AI-Powered CI/CD System
-- Created: 2025-05-28
-- Version: 1.0.0

-- This migration creates the complete schema as defined in src/database/schema.sql
-- It includes all tables, indexes, triggers, and initial data for the TaskMaster system
...
('1.0.0', 'Initial comprehensive schema for AI-powered CI/CD system', 'sha256:comprehensive_v1')
