 ...
 * Central configuration for workflow engine and related components
 */

export const WORKFLOW_CONFIG = {
    // Engine Configuration
    engine: {
        maxConcurrentWorkflows: process.env.MAX_CONCURRENT_WORKFLOWS || 10,
    ...
    stateManager: {
        ...
        database: {
            ...
            database: process.env.DATABASE_NAME || 'workflow_db',
            username: process.env.DATABASE_USERNAME || 'workflow_user',
    ...
    agentManager: {
        ...
        loadBalancing: {
            ...
            strategy: process.env.AGENT_LOAD_BALANCE_STRATEGY || 'round_robin', // 'round_robin', 'least_connections', 'weighted'
            weights: {
    ...
    monitoring: {
        ...
        alerts: {
            ...
            thresholds: {
                failureRate: parseFloat(process.env.ALERT_FAILURE_RATE_THRESHOLD) || 0.1, // 10%
                avgExecutionTime: parseInt(process.env.ALERT_AVG_EXECUTION_TIME_THRESHOLD) || 1800000, // 30 minutes
                queueSize: parseInt(process.env.ALERT_QUEUE_SIZE_THRESHOLD) || 50,
                resourceUtilization: parseFloat(process.env.ALERT_RESOURCE_UTILIZATION_THRESHOLD) || 0.8 // 80%
            }
        }
    },
    ...
    security: {
        authentication: {
            ...
            type: process.env.AUTH_TYPE || 'jwt', // 'jwt', 'api_key', 'oauth'
            jwt: {
        ...
        authorization: {
            ...
            rbac: {
                ...
                roles: {
                    admin: ['workflow:create', 'workflow:read', 'workflow:update', 'workflow:delete', 'workflow:execute'],
