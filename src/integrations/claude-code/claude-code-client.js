...
export class ClaudeCodeClient {
    ...
    async checkAuthentication() {
        try {
            const result = await this.executeCommand(['config', 'get', 'auth.token'], {
                timeout: 10000,
                suppressOutput: true
            });
    ...
    async query(query, options = {}) {
        ...
        const configArgs = this.config.generateCliArgs({ outputFormat, ...options });
    ...
    async analyzeCodeQuality(target, options = {}) {
        ...
        return await this.query(query, {
            ...options,
            systemPrompt: 'You are a senior code reviewer focused on quality, security, and maintainability. Provide detailed, actionable feedback.'
        });
    }
    ...
    async validatePullRequest(prBranch, baseBranch = 'main', options = {}) {
        ...
        return await this.query(query, {
            ...options,
            systemPrompt: 'You are an expert code reviewer performing PR validation. Focus on quality gates, security, and maintainability.'
        });
    }
    ...
    async debugBuildFailure(errorLog, options = {}) {
        ...
        return await this.query(query, {
            ...options,
            systemPrompt: 'You are a debugging expert. Provide clear, actionable solutions for build failures.'
        });
    }
    ...
    async analyzePerformance(target, options = {}) {
        ...
        return await this.query(query, {
            ...options,
            systemPrompt: 'You are a performance optimization expert. Focus on measurable improvements and best practices.'
        });
    }
